...
- object_name: сторона рельсовой нити — «левая нить» или «правая нить» (по ходу роста километража). Это указатель места, НЕ defect и не отдельный item
- «на левой стороне рельсовой нити отсутствует болт» → object_name «левая нить», один item с defect «отсутствует стыковой болт»
"""
